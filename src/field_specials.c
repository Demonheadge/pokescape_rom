...
u8 GetSSTidalLocation(s8 *mapGroup, s8 *mapNum, s16 *x, s16 *y)
{
    ...
    switch (*GetVarPointer(VAR_TEMP_0))
    {
...
void SetTrickHouseNuggetFlag(void)
{
    ...
    u16 flag = FLAG_HIDDEN_ITEM_LUMBRIDGE_ITEM_1;
    *specVar = flag;
    FlagSet(flag);
}
...
{
    u16 monData;
    CreateMon(&gPlayerParty[0], SPECIES_IMP, 7, USE_RANDOM_IVS, FALSE, 0, OT_ID_PLAYER_ID, 0);
    monData = TRUE;
