...
static void Cmd_getexp(void)
{
    ...
    case 0: // check if should receive exp at all
        ...
        {
            if (FlagGet(FLAG_EXP_ALL)) // FLAG_EXP_ALL
            {
...
static void Cmd_switchineffects(void)
{
    ...
    else
    {
        ...
        if (AbilityBattleEffects(ABILITYEFFECT_ON_SWITCHIN, gActiveBattler, 0, 0, 0)
            ...
            || AbilityBattleEffects(ABILITYEFFECT_PETRIFY2,0,0,0,0))
            return;
...
static void Cmd_various(void)
{
    ...
    case VARIOUS_PLAY_TRAINER_DEFEATED_MUSIC:
        BtlController_EmitPlayFanfareOrBGM(BUFFER_A, MUS_PS_TRAINER_VICTORY, TRUE);
        MarkBattlerForControllerExec(gActiveBattler);
        break;
    ...
    case VARIOUS_SWITCHIN_ABILITIES:
        ...
        AbilityBattleEffects(ABILITYEFFECT_PETRIFY2, gActiveBattler,0,0,0);
        return;
...
static void Cmd_handleballthrow(void)
{
    ...
    else
    {
        ...
        case ITEM_GRANITE_POUCH:
            w = GetPokedexHeightWeight(SpeciesToNationalPokedexNum(gBattleMons[gBattlerTarget].species), 1);
            if (w < 1024)
                ballMultiplier = 5;
            else if (w < 2048)
                ballMultiplier = 10;
