static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_GRAND_EXCHANGE - 1] = {MAP_GROUP(GRAND_EXCHANGE), MAP_NUM(GRAND_EXCHANGE), 20, 20},
    ...
    [HEAL_LOCATION_DAEMONHEIM - 1] = {MAP_GROUP(DAEMONHEIM), MAP_NUM(DAEMONHEIM), 10, 10},
};
