...
const u8 gText_RepelEffectsLingered[] = _("But you are already under the calming\neffects of TEA.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_NewGame_Region_5[] =_("YANILLE");
const u8 gText_NewGame_Region_6[] =_("ARDOUGNE");
