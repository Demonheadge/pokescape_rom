...
enum {
    ...
    NATIONAL_DEX_END, //Cupholder Test
// Kanto
...
#define NATIONAL_DEX_COUNT_START    NATIONAL_DEX_GUTHLING
#define NATIONAL_DEX_COUNT          NATIONAL_DEX_END //cupholder test
...
enum {
    ...
    F2P_DEX_SARAOWL,
    F2P_DEX_CHICK,
    F2P_DEX_CHICKEN_NORMAL_FORM,
    F2P_DEX_DREADFOWL,
    F2P_DEX_ROOSTER_NORMAL_FORM,
    F2P_DEX_EVILCHICKEN,
    F2P_DEX_CALF,
    F2P_DEX_COW,
    F2P_DEX_BULL,
    F2P_DEX_RAT_NORMAL_FORM,
    F2P_DEX_GIANT_RAT_NORMAL_FORM,
    F2P_DEX_GIANT_RAT_BLESSED_FORM,
    F2P_DEX_LAMB,
    F2P_DEX_SHEEP_WHITE_FORM,
    F2P_DEX_SHEEP_PIRATE_FORM,
    F2P_DEX_FROG_NORMAL_FORM,
    F2P_DEX_GIANT_FROG_NORMAL_FORM,
    F2P_DEX_GIANT_FROG_ROYAL_FORM,
    F2P_DEX_SPIDERLING,
    F2P_DEX_SPIDER_GIANT_FORM,
    F2P_DEX_SPIDER_DEADLYRED_FORM,
    F2P_DEX_SARDINE,
    F2P_DEX_HERRING,
    F2P_DEX_TROUT_NORMAL_FORM,
    F2P_DEX_SWORDFISH,
    F2P_DEX_KARAMBWANJ,
    F2P_DEX_KARAMBWAN,
    F2P_DEX_PIGLET,
    ...
    F2P_DEX_WALL_BEAST,
    F2P_DEX_SCORPLING,
    F2P_DEX_SCORPION_NORMAL_FORM,
    F2P_DEX_SCORPION_KING_FORM,
    F2P_DEX_SQUIRREL,
    F2P_DEX_RAVENLING,
    F2P_DEX_RAVEN_NORMAL_FORM,
    F2P_DEX_BAT,
    F2P_DEX_GIANT_BAT,
    F2P_DEX_WARPED_BAT,
    F2P_DEX_CRAYFISH,
    F2P_DEX_SHRIMP,
    F2P_DEX_LOBSTER_NORMAL_FORM,
    F2P_DEX_PLANT_STRANGE_FORM,
    F2P_DEX_PLANT_STRANGER_FORM,
    F2P_DEX_EVILTURNIP,
    F2P_DEX_BABY_MOLE,
    F2P_DEX_GIANT_MOLE,
    F2P_DEX_PURE,
    F2P_DEX_RUNE,
    F2P_DEX_ESSENCE,
    F2P_DEX_RUNE_GUARDIAN,
    F2P_DEX_DUCKLING,
    F2P_DEX_DUCK_NORMAL_FORM,
    F2P_DEX_SWAN,
    F2P_DEX_CRAB_RED_FORM,
    F2P_DEX_GIANT_CRAB_RED_FORM,
    F2P_DEX_CRAWLER_CAVE_FORM,
    F2P_DEX_CRAWLER_CHASM_FORM,
    F2P_DEX_CRAWLER_MONSTROUS_FORM,    
    F2P_DEX_TZ_KIH,
    F2P_DEX_TZ_KEK,
    F2P_DEX_TOK_XIL,
    F2P_DEX_KET_DILL,
    ...
    F2P_DEX_TZTOK_JAD,
    F2P_DEX_CAVE_SLIME,
    F2P_DEX_JELLY_NORMAL_FORM,
    F2P_DEX_JELLY_WARPED_FORM,
    F2P_DEX_ABYSSALING,
    F2P_DEX_ABYSSAL_MINION_FORM,
    F2P_DEX_ABYSSAL_DEMON_FORM,
    F2P_DEX_ABYSSAL_SIRE_FORM,
    F2P_DEX_BIRDS_NEST_GOD_FORM,
    F2P_DEX_BIRD_NEST,
    F2P_DEX_PIGEON,
    F2P_DEX_PHEASANT,
    F2P_DEX_FOAL,
    F2P_DEX_UNICORN_WHITE_FORM,
    F2P_DEX_UNICORN_STALLION_FORM,
    F2P_DEX_BEAR_CUB,
    F2P_DEX_BEAR_NORMAL_FORM,
    F2P_DEX_MONKEY_NORMAL_FORM,
    F2P_DEX_ROCK_CRAB_AMMONITE_FORM,
    F2P_DEX_ROCK_CRAB_GIANT_AMMONITE_FORM,
    F2P_DEX_TOY_MOUSE,
    F2P_DEX_TOY_DOLL,
    F2P_DEX_TOY_SOLDIER,
    F2P_DEX_ANICHAIR,
    ...
    F2P_DEX_ENT,
    F2P_DEX_DERWEN,
    F2P_DEX_SEAGULL_NORMAL_FORM,
    F2P_DEX_PELICAN,
    F2P_DEX_IMP,
    F2P_DEX_DEMON_LESSER_OSRS_FORM,
    F2P_DEX_DEMON_GREATER_OSRS_FORM,
    F2P_DEX_DEMON_TORMENTED_FORM,
    F2P_DEX_CATABLEPON,
    F2P_DEX_MINOTAUR_NORMAL_FORM,
    F2P_DEX_CAVE_BUG,
    F2P_DEX_COCKROACH_DRONE,
    F2P_DEX_COCKROACH_WORKER,
    F2P_DEX_COCKROACH_SOLDIER,
    F2P_DEX_IMPLING_BABY_FORM,
    F2P_DEX_IMPLING_GOURMET_FORM,
    F2P_DEX_IMPLING_DRAGON_FORM,
    F2P_DEX_DRAGONLING_GREEN_FORM,
    F2P_DEX_DRAGON_GREEN_FORM,
    F2P_DEX_DRAGON_BRUTAL_GREEN_FORM,
    F2P_DEX_ELVARG,
    F2P_DEX_DRAGON_KING_BLACK_FORM,
    F2P_DEX_DRAGON_QUEEN_BLACK_FORM,
};

#define F2P_DEX_COUNT         F2P_DEX_DRAGON_QUEEN_BLACK_FORM
